...
| Possession | Six-state accuracy | 39.8% |
| Possession | Controlled precision / recall / F1 | 86.6% / 58.7% / 70.0% |
...
1. **possession_state** — Six-state possession accuracy is 39.8%; the pipeline currently emits only controlled or loose for this benchmark.
2. **possession_team_end_to_end** — End-to-end possession-team accuracy is 54.5% with 55.4% team coverage.
3. **controlled_possession_recall** — Controlled-possession recall is 58.7%.
4. **ball_detection** — Only 81.3% of visible balls have an observed post-filter detection; the rest depend on interpolation.
5. **ball_localization_50px** — Only 87.3% of visible balls are localized within 50 pixels after interpolation.
6. **events** — Event F1 is 88.9% at ±15 frames (8 TP, 0 FP, 2 FN).

## Root-cause signals

- 15 controlled-possession misses are attributed to `interpolated_ball_not_confirmable`.
...
|---|---:|---:|---:|---:|---:|
| video_1 | 9 | 50.0% | 75.0% | 57.1% | 40.0% |
| video_2 | 38 | 96.8% | 100.0% | 84.6% | 81.5% |
| video_3 | 58 | 89.4% | 89.4% | 56.1% | 40.5% |
| spursknicksclip | 59 | 77.5% | 87.5% | 79.4% | 56.8% |
| spursknicks2 | 37 | 62.5% | 70.8% | 50.0% | 40.0% |
